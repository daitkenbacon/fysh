    ...
    <form onSubmit={handleSubmit}>
      ...
      {selectedImage && (
        <div className="w-full px-5 flex flex-col justify-center content-center items-center">
          <img
            className="rounded-lg mx-h-500"
            src={previewImage}
            alt="Catch submission"
          />
        </div>
      )}
      {selectedImage && (
        <div className="mx-5">
          <button
            ...
            type="button"
            className="w-full my-2 justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 sm:mx-3 sm:w-auto sm:text-sm"
          >
