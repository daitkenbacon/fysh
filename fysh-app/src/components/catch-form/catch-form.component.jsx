        ...
        <form onSubmit={handleSubmit}>
            <div className='mx-5'>
                ...
                <div className="relative mt-1 rounded-md shadow-sm">
                    ...
                    id="description"
                    className="mb-2 block w-full rounded-md border-gray-300 pl-3 pr-3 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
            ...
            <div className="bg-gray-50 w-full px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                ...
                <button onClick={() => setOpenFormModal(false)} type="button" className="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">Cancel</button>
            </div>
        </form>
    )
}
