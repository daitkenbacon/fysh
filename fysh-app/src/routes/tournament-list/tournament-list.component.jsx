...
const TournamentList = () => {
    ...
    <div className="bg-white">
      ...
      <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        {isLoading &&
             <div className="text-center absolute top-1/4 left-1/2">
                <div role="status">
                    <svg aria-hidden="true" className="w-20 h-20 mr-2 text-gray-100 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
