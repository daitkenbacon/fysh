      ...
      <div className="mx-auto max-w-2xl pb-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <div>
          <div className="bg-white rounded-3xl p-8 mb-5">
            <div className='flex flex-row items-center align-center text-left gap-2 justify-center'>
              <img className='rounded-full w-100' src={user.avatar}/>
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-x-20">
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-blue-600 rounded-xl text-white">
                    <div className="font-bold text-2xl leading-none">2</div>
                    <div className="mt-2">Catches submitted</div>
                  </div>
                  <div className="col-span-2">
