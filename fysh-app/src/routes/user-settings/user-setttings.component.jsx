...
const UserSettings = () => {
  const { currentUser, currentUserName, currentUserDoc, currentUserUID } =
              ...
              <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                {currentUser && !currentUser.emailVerified && (
                  <button
                    ...
                    onClick={() => {
                      triggerEmailVerification(currentUser);
              ...
              <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                {currentUser && (
                  <button
                    className="font-medium text-sm text-blue-600 hover:text-blue-500"
                    onClick={() => {
                      triggerPasswordReset(currentUser.email);
                ...
                <div className="w-full">
                  ...
                  {selectedImage && (
                    <button
                      ...
                      className="mt-2 text-white bg-blue-600 hover:bg-blue-700 p-1 rounded flex-shrink-0"
                    >
